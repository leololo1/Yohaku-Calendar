...
export type Slide = {
  ...
  screenshotTertiary?: string; // optional third device for gallery compositions
  screenshotQuaternary?: string; // optional fourth device for gallery compositions
  inverted?: boolean;         // dark background variant
  backgroundColor?: string;   // optional solid background color for this slide
  headlineColor?: string;     // optional headline color for this slide
  headlineFontFamily?: string; // optional headline font stack for this slide
