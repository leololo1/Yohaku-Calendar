...
const ELEMENT_LABEL: Record<BuiltInElementId, string> = {
  ...
  deviceTertiary: "Gallery device 3",
  deviceQuaternary: "Gallery device 4",
};
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        {slide.layout === "two-devices" && slide.screenshotTertiary !== undefined && (
          <div className="space-y-1.5">
            <Label className="text-xs">Gallery device 3 screenshot</Label>
            <ScreenshotPicker
              label="Tertiary"
        ...
        {slide.layout === "two-devices" && slide.screenshotQuaternary !== undefined && (
          <div className="space-y-1.5">
            <Label className="text-xs">Gallery device 4 screenshot</Label>
            <ScreenshotPicker
              label="Quaternary"
              value={slide.screenshotQuaternary || ""}
              locale={locale}
              onChange={(v) => onChange({ screenshotQuaternary: v })}
            />
          </div>
        )}
...
function ElementTransformControls({
  ...
  if (slide.layout === "two-devices" && slide.screenshotTertiary !== undefined) present.push("deviceTertiary");
  if (slide.layout === "two-devices" && slide.screenshotQuaternary !== undefined) present.push("deviceQuaternary");
